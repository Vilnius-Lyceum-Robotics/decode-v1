...
public class PointsFar {
    ...
    public static final Pose START_POS = new Pose(60, 8.2, Math.toRadians(90));
    public static final Pose SHOOT_POS = new Pose(60, 40, Math.toRadians(135));
    ...
    public static final Pose SHOOT_POS3 = new Pose(60, 120, Math.toRadians(90));
