...
import static org.firstinspires.ftc.teamcode.config.pedroPathing.PointsFar.EXIT_POS;
...
@Autonomous(name = "Auto exit launch", group = "!")
public class AutoDriveForward extends OpMode {
    ...
    public void buildCommands(){
        ...
        stagesList.add(new PathHolder(getPath(START_POS, EXIT_POS)));
