...
import static org.firstinspires.ftc.teamcode.config.pedroPathing.PointsFar.SHOOT_POS1;
...
@Autonomous(name = "Auto test v1.2", group = "Auto")
public class FirstAutoTest2 extends OpMode {
...
//                .setLinearHeadingInterpolation(pos1.getHeading(), pos2.getHeading(), 0.8)
    ...
    public void buildCommands(){
        ...
        stagesList.add(new PathHolder(getPath(START_POS, SHOOT_POS1)));
